...
GUID = '69bb6fb3-5534-4b98-99a9-60ed71864c94'
...
CmdletsToExport = @(
  ...
  'Set-ShellServerPath',
  'Set-ShellServerPathFuzzy',
  'Get-ShellServerListDir',
  'Get-ShellServerListDirAll',
  'Search-ShellServerHistory',
  'Invoke-ShellServerEnterKeyHandler',
...
AliasesToExport = @('prompt', 'p', 'pz', 'll', 'la')
